...
export const myProjects = [
  {
    ...
    desc: 'This project originated from the challenge many students face in maintaining focus and motivation during study or work sessions. Our team identified that traditional time management methods often lack engagement, leading to decreased productivity. As team leader, I guided the group in researching gamification strategies and Human-Computer Interaction principles to address this issue.',
    subdesc:
  ...
  },
  {
    ...
    desc: 'The project was initiated to deepen my understanding of backend development and strengthen practical coding skills beyond the classroom. I identified the challenge of managing backend workflows and data handling, which often require structured logic and efficient implementation. To address this, I conducted self-directed research on backend frameworks, PHP integration, and database management practices.',
    subdesc:
  ...
  },
  {
    ...
    desc: 'The project was motivated by the difficulty students encounter when conducting science experiments that are either unsafe or limited by resources. To solve this, I researched the potential of Augmented Reality (AR) in education and explored frameworks such as Unity and Vuforia. Guided by the ADDIE instructional model, I developed a mobile AR application that allows students to simulate experiments like volcanic eruptions, lava lamps, and litmus tests.',
    subdesc:
  ...
  },
  {
    ...
    desc: 'The project was initiated to address the lack of accessible platforms where students and graduates can practice and improve soft skills through peer-to-peer learning. Our team identified that while many platforms focus on hard skills, soft skills such as communication, teamwork, and leadership remain underrepresented. To solve this, we researched peer learning models, conducted student surveys, and studied UI/UX accessibility principles.',
    subdesc:
  ...
  },
  {
    ...
    desc: 'This project was motivated by the communication barriers faced by the speech- and hearing-impaired community in Indonesia, especially those using SIBI (Sistem Isyarat Bahasa Indonesia). Our team identified that limited accessibility tools hinder inclusivity in education and everyday communication. To address this issue, we researched gesture recognition methods and real-time AI solutions.',
    subdesc:
